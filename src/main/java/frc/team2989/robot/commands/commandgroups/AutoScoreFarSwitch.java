...
public class AutoScoreFarSwitch extends CommandGroup {
    ...
    public AutoScoreFarSwitch() {
        ...
        Stream.of(
            new AutoDriveEncoder(RobotMap.AUTONOMOUS_FAR_DRIVE_DISTANCE, RobotMap.AUTONOMOUS_FAR_DRIVE_DEVIATION, RobotMap.AUTONOMOUS_FAR_DRIVE_SPEED, RobotMap.AUTONOMOUS_FAR_DRIVE_ROTATION)
            ...
            ,new AutoDriveEncoder(RobotMap.AUTONOMOUS_FAR_DRIVE_PAST_DISTANCE, RobotMap.AUTONOMOUS_FAR_DRIVE_PAST_DEVIATION, RobotMap.AUTONOMOUS_FAR_DRIVE_PAST_SPEED, RobotMap.AUTONOMOUS_FAR_DRIVE_PAST_ROTATION)
            ...
            ,new AutoDriveEncoder(RobotMap.AUTONOMOUS_FAR_DRIVE_TO_DISTANCE, RobotMap.AUTONOMOUS_FAR_DRIVE_TO_DEVIATION, RobotMap.AUTONOMOUS_FAR_DRIVE_TO_SPEED, RobotMap.AUTONOMOUS_FAR_DRIVE_TO_ROTATION)
            ...
            ,new AutoDriveEncoder(RobotMap.AUTONOMOUS_FAR_DRIVE_INTO_DISTANCE, RobotMap.AUTONOMOUS_FAR_DRIVE_INTO_DEVIATION, RobotMap.AUTONOMOUS_FAR_DRIVE_INTO_SPEED, RobotMap.AUTONOMOUS_FAR_DRIVE_INTO_ROTATION)
            ,new AutoLaunchCube(RobotMap.AUTONOMOUS_FAR_LAUNCH_SPEED, 1)
